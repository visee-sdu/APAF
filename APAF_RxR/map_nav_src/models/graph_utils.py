...
class GraphMap(object):
    def __init__(self, start_vp):
        ...
        self.node_object_embeds = {}
        self.node_action_embeds = {}
    ...
    def update_node_object_embed(self, vp, embed):
        self.node_object_embeds[vp] = embed
    
    def get_node_object_embed(self, vp):
        return self.node_object_embeds[vp]
    
    def update_node_action_embed(self, vp, embed):
        self.node_action_embeds[vp] = embed
    
    def get_node_action_embed(self, vp):
        return self.node_action_embeds[vp]
