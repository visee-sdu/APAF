...
def get_img(proc_id, out_queue, scanvp_list, args):
    ...
    for scan_id, viewpoint_id in scanvp_list:
        if scan_id != pre_scan:
            ...
            habitat_sim = HabitatUtils(f'/home/huangbw/navigation/MP3D/MP3DSim/data/v1/tasks/mp3d/{scan_id}/{scan_id}.glb', 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scan_dir', default='../MP3D/MP3DSim/data/v1/scans') # mp3d scan path
