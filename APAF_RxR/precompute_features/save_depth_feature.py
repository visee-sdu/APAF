...
if __name__ == '__main__':
    ...
    # the weight of DDPPO, url: https://github.com/facebookresearch/habitat-lab/tree/main/habitat-baselines/habitat_baselines/rl/ddppo
    parser.add_argument('--checkpoint_file', default='/home/huangbw/navigation/BEVBert/ckpts/gibson-2plus-resnet50.pth') 
    parser.add_argument('--connectivity_dir', default='datasets/R2R/connectivity')
    parser.add_argument('--scan_dir', default='/home/huangbw/navigation/MP3D/MP3DSim/data/v1/scans')
