...
def parse_args():
    ...
    parser.add_argument('--expert_policy', default='spl', choices=['spl', 'ndtw', 'union'])
    ...
    parser.add_argument('--object_file', type=str, default='./object_feature/hm3d_mp3d_object_features.hdf5')
    parser.add_argument('--object_dim', type=int, default=512)
